...
<!-- $Id: omobj-pmml.xsl 1943 2001-11-20 22:03:55Z kohlhase $ -->
...
<xsl:template match="OMS">
  ...
  <xsl:if test="parent::OMA and not(preceding-sibling::*)">
  <!-- <mo>&ApplyFunction;</mo> -->
  <mrow>
  <mo>(</mo>
...
<xsl:template name="infix" >
  ...
  <xsl:choose>
  <xsl:when test="parent::OMA and not(preceding-sibling::*)">
  <mrow>
...
<xsl:template match="OMA[OMS[@name='times' and @cd='arith1']]">
 <mrow>
...
<xsl:template match="OMS[@cd='arith1' and @name='plus']"  >
  <xsl:param name="p"/>
  <xsl:choose>
  <xsl:when test="parent::OMA and not(preceding-sibling::*)">
  <mrow>
  ...
  <xsl:for-each select="following-sibling::*">
   ...
   <xsl:when test="position() &gt; 1 and 
             self::OMA/*[1][self::OMS[@name='unary_minus']]">
    <mo>-</mo>
   <xsl:apply-templates select="*[2]">
   ...
   <xsl:when test="position() &gt; 1 and 
             self::OMA[*[position()=1 and last()=3]
                         [self::OMS and @name='times']]/
              *[2][self::OMA]/*[1][self::OMS[@name='unary_minus']]">
    <mo>-</mo>
   <mrow>
...
<xsl:template match="OMS[(@cd='arith1' or @cd='arith2') and @name='times']"  >
  <xsl:param name="p"/>
  <xsl:call-template name="infix">
    <xsl:with-param name="mo">
    <mo>
    <xsl:choose>
    <xsl:when test="following-sibling::*[not(self::OMI or self::OMF)]"
    ></xsl:when>
...
<xsl:template match="OMS[@cd='arith1' and @name='divide']"  >
  <xsl:param name="p"/>
...
<xsl:template match="OMS[@cd='arith1' and @name='minus']"  >
  <xsl:param name="p"/>
  <xsl:call-template name="infix">
...
<xsl:template match="OMS[@cd='arith1' and @name='plusminus']"  >
  <xsl:param name="p"/>
  <xsl:call-template name="infix">
...
<xsl:template match="OMS[@cd='arith1' and @name='unary_minus']"  >
   <mrow>
   <mo>-</mo>
   <xsl:apply-templates select="following-sibling::*[1]"/>
   </mrow>
...
<xsl:template match="OMS[@cd='arith1' and @name='power']"  >
   <msup>
   <xsl:apply-templates select="following-sibling::*[1]"/>
   <xsl:apply-templates select="following-sibling::*[2]"/>
   </msup>
...
<xsl:template match="OMS[@cd='arith1' and @name='conjugate']"  >
   <mover>
   <xsl:apply-templates select="following-sibling::*[1]"/>
   </mover>
</xsl:template>

<xsl:template match="OMS[@cd='arith1' and @name='abs']"  >
   <mo>|</mo>
   <xsl:apply-templates select="following-sibling::*[1]"/>
   <mo>|</mo>
</xsl:template>

<xsl:template match="OMS[@cd='arith1' and @name='root']"  >
   <xsl:choose>
   <xsl:when test="following-sibling::*[2]/self::OMI[normalize-space(.)='2']">
   <msqrt
   ><xsl:apply-templates select="following-sibling::*[1]"
   /></msqrt>
   </xsl:when>
...
<xsl:template
  match="OMS[@cd='arith1' and (@name='sum' or @name='product')]"  >
   <xsl:choose>
<!--
...
zap the lambda.
-->
   <xsl:when test="following-sibling::*[2]/self::OMBIND/*[1][self::OMS[@name='lambda']]">
...
-->
   <xsl:when test="following-sibling::*[1]/self::OMA/*[1][self::OMS[@name='integer_interval']]">
   <munderover>
   <mo>
   <xsl:choose>
   ...
   <mrow>
   <xsl:apply-templates select="following-sibling::OMBIND/OMBVAR"/>
   <mo>=</mo>
   <xsl:apply-templates select="following-sibling::OMA/*[2]"/>
   </mrow>
   <xsl:apply-templates select="following-sibling::OMA/*[3]"/>
   </munderover>
   </xsl:when>
   <xsl:otherwise>
   <munder>
   ...
   <xsl:apply-templates select="following-sibling::OMBIND/*[3]"/>
   </xsl:when>
...
<!--
  ...
  -->
<xsl:template match="OMA[OMS[@name='divides' and @cd='ida']]">
 <mrow>
  <xsl:apply-templates select="*[2]"/>
  <mo>|</mo>
  <xsl:apply-templates select="*[3]"/>
...
<!--
  ...
  -->
<xsl:template  match="OMS[@cd='limit1' and @name='limit']"  >
  <munder>
   <mi>lim</mi>
   <mrow>
   <xsl:apply-templates select="following-sibling::OMBIND/OMBVAR"/>
...
<!--
  ...
  -->
<xsl:template match="OMA[OMS[@name='eq' and @cd='relation1']]">
 <mrow>
  <xsl:apply-templates select="*[2]"/>
  <mo>=</mo>
  <xsl:apply-templates select="*[3]"/>
...
<!--
  ...
  -->
<xsl:template match="OMA[OMS[@name='lt' and @cd='relation1']]">
 <mrow>
  <xsl:apply-templates select="*[2]"/>
  <mo>&lt;</mo>
  <xsl:apply-templates select="*[3]"/>
...
<!--
  ...
  -->
<xsl:template match="OMA[OMS[@name='gt' and @cd='relation1']]">
 <mrow>
  <xsl:apply-templates select="*[2]"/>
  <mo>&gt;</mo>
  <xsl:apply-templates select="*[3]"/>
...
<!--
  ...
  -->
<xsl:template match="OMA[OMS[@name='leq' and @cd='relation1']]">
 <mrow>
  <xsl:apply-templates select="*[2]"/>
  <mo>&leq;</mo>
  <xsl:apply-templates select="*[3]"/>
...
<xsl:template match="OMS[@cd='set1' and @name='set']" >
<mrow>
<mo>{</mo>
<xsl:for-each  select="following-sibling::*">
 <xsl:apply-templates select="."/>
...
<xsl:template match="OMA[OMS[@name='setdiff' and @cd='set1']]">
 <mrow>
  <xsl:apply-templates select="*[2]"/> 
   <mo>&setminus;</mo>
   <xsl:apply-templates select="*[3]"/>
...
<xsl:template match="OMS[@cd='nums' and @name='e']"  >
<mi>&ExponentialE;</mi>
</xsl:template>

<xsl:template match="OMS[@cd='nums' and @name='i']"  >
<mi>&ImaginaryI;</mi>
</xsl:template>


<xsl:template match="OMS[@cd='nums' and @name='pi']"  >
<mi>&pi;</mi>
</xsl:template>

<xsl:template match="OMS[@cd='nums' and @name='gamma']"  >
<mi>&gamma;</mi>
</xsl:template>
...
<!--
  ...
  -->
<xsl:template match="OMS[@name='infinity' and @cd='nums1']">
...
<!--
  ...
  -->
<xsl:template match="OMS[@name='Z' and @cd='setname']">
...
<!--
  ...
  -->
<xsl:template match="OMS[@name='N' and @cd='setname']">
...
<!--
  ...
  -->
<xsl:template match="OMS[@name='Q' and @cd='setname']">
...
<!--
  ...
  -->
<xsl:template match="OMS[@name='R' and @cd='setname']">
...
<!--
  ...
  -->
<xsl:template match="OMS[@name='C' and @cd='setname']">
...
<xsl:template match="OMS[@cd='ida' and @name='sequence']" >
	<mrow>
	<xsl:for-each select="following-sibling::*">
        <xsl:apply-templates select="."/>
	<xsl:if test="position() &lt; last()"><mo>,</mo> </xsl:if>
...
<xsl:template match="OMA[OMS[@cd='integer' and @name='rem']]" >
	<mrow>
	<mi>rem</mi><mo>(</mo>
	  	<xsl:apply-templates select="*[2]"/>
  		<mo>, </mo>
...
<xsl:template match="OMA[OMS[@cd='integer' and @name='gcd']]" >
	<mrow>
	<mi>GCD</mi><mo>(</mo>
	  	<xsl:apply-templates select="*[2]"/>
  		<mo>, </mo>
...
<xsl:template match="OMS[@cd='interval' and @name='interval_cc']" >
   <mo>[</mo>
   <xsl:apply-templates select="following-sibling::*[1]"/>
   <mo>,</mo>
   <xsl:apply-templates select="following-sibling::*[2]"/>
